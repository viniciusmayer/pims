...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tipo.categoria'
        db.add_column(u'backend_tipo', 'categoria',
                      self.gf('django.db.models.fields.CharField')(default='IN', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tipo.categoria'
        db.delete_column(u'backend_tipo', 'categoria')
    ...
    models = {
        ...
        u'backend.instituicao': {
            'Meta': {'ordering': "['-ativo', 'nome', '-data_hora_atualizacao', '-data_hora_criacao']", 'object_name': 'Instituicao'},
        ...
        u'backend.investimento': {
            'Meta': {'ordering': "['-ativo', 'nome', '-data_hora_atualizacao', '-data_hora_criacao']", 'object_name': 'Investimento'},
            'ativo': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'data_hora_atualizacao': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'data_hora_criacao': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'excluido': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'backend.valor': {
            'Meta': {'ordering': "['-ativo', '-data', '-data_hora_atualizacao', '-data_hora_criacao']", 'object_name': 'Valor'},
            'ativo': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'data': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 23, 0, 0)'}),
            'data_hora_atualizacao': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'data_hora_criacao': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'excluido': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
