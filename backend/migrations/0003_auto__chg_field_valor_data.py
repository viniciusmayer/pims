...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Valor.data'
        db.alter_column(u'backend_valor', 'data', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Valor.data'
        db.alter_column(u'backend_valor', 'data', self.gf('django.db.models.fields.DateTimeField')())
