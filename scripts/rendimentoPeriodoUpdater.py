...
selectRendimentoPorPeriodo = 'select id, periodo from backend_rendimentoporperiodo'
selectPeriodo = 'select id from backend_periodo where data = ''\'{0}''\''
update = 'update backend_rendimentoporperiodo set "periodoTempo_id" = {0} where id = {1}'
